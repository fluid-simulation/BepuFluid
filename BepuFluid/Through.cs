...
namespace BepuFluid
{
    class Through
    {
        ...
        public Through(Vector3 center, float width, float length, float angleX, float angleZ)
        {
            Vector3 pos1 = new Vector3(center.X - width / 2, center.Y, center.Z);
            Box1 = new Box(pos1, width, 0.1f, length);
            ...
            Box2 = new Box(pos2, width, 0.1f, length);
